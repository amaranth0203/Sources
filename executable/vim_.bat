...
if exist "%UserProfile%/qyh_session_vim.vim" (
    "D:\Program Files\Vim\vim74\vim.exe" -u "C:\Users\Ending\.qyh_vim\vimrc" -S "%UserProfile%/qyh_session_vim.vim" %*
) else (
...
start "%VIM_EXE_DIR%\vim.exe" -u C:\Users\Ending\.qyh_vim\vimrc  %VIMARGS%
goto eof

:nofork
start /w "%VIM_EXE_DIR%\vim.exe" -u C:\Users\Ending\.qyh_vim\vimrc  %VIMARGS%
goto eof

:ntaction
rem for WinNT we can use %*
if .%VIMNOFORK%==.1 goto noforknt
start "dummy" /b "%VIM_EXE_DIR%\vim.exe" -u C:\Users\Ending\.qyh_vim\vimrc  %*
goto eof

:noforknt
start "dummy" /b /wait "%VIM_EXE_DIR%\vim.exe" -u C:\Users\Ending\.qyh_vim\vimrc  %*
